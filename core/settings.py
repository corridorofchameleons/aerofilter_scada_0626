...
class Settings:
    ...
    # ошибки
    ERROR_WIDGET_WIDTH = 100 * SCENE_SCALE
    ERROR_WIDGET_HEIGHT = 70 * SCENE_SCALE
    ...
    PIPE_OUTER_COLOR_ACTIVE = "#2A6922"
    ...
    VALUE_BOX_ERROR_BACKGROUND_COLOR = "#FF6666"
    VALUE_BOX_TITLE_BACKGROUND_COLOR = "#B0BEC5"

    ERROR_WIDGET_BACKGROUND_COLOR = '#FF2400'
