    ...
    def __init__(
        ...
        self.pipes = [
            ...
            Pipe((1,), OIL_LEFT_BOTTOM_KNEE_X, OIL_LEFT_BOTTOM_KNEE_Y, OIL_PUMP_X, OIL_LEFT_BOTTOM_KNEE_Y,
                 horizontal=True, start_joint='left', contour=(1,), arrow_rotation=0),
            Pipe((1,), OIL_PUMP_X, OIL_RIGHT_BOTTOM_KNEE_Y, OIL_RIGHT_BOTTOM_KNEE_X, OIL_RIGHT_BOTTOM_KNEE_Y,
                 horizontal=True, end_joint='left', contour=(1,), arrow_rotation=0),
            ...
            #      horizontal=True,
            #      start_joint='left', end_joint='left', contour=(1,)),
            # Pipe((2,), FUEL_LEFT_TOP_KNEE_X, FUEL_LEFT_TOP_KNEE_Y, FUEL_LEFT_BOTTOM_KNEE_X, FUEL_LEFT_BOTTOM_KNEE_Y,
            #      horizontal=False, start_joint='left', end_joint='left', contour=(1,)),
            # Pipe((2,), FUEL_LEFT_BOTTOM_KNEE_X, FUEL_LEFT_BOTTOM_KNEE_Y, FUEL_PUMP_X, FUEL_LEFT_BOTTOM_KNEE_Y,
            #      horizontal=True, start_joint='left', contour=(1,)),
            # Pipe((2,), FUEL_PUMP_X, FUEL_RIGHT_BOTTOM_KNEE_Y, FUEL_RIGHT_BOTTOM_KNEE_X, FUEL_RIGHT_BOTTOM_KNEE_Y,
            #      horizontal=True, end_joint='left', contour=(1,)),
            # Pipe((2,), FUEL_RIGHT_BOTTOM_KNEE_X, FUEL_RIGHT_BOTTOM_KNEE_Y, FUEL_RIGHT_TOP_KNEE_X, FUEL_RIGHT_TOP_KNEE_Y,
            #      horizontal=False, start_joint='left', end_joint='left', contour=(1,)),
            #
            # # тонкие трубы верх
            # Pipe((2,), FUEL_AFTER_FILTER_BOTTOM_X, FUEL_AFTER_FILTER_BOTTOM_Y, FUEL_BEFORE_FILTER_TOP_X,
            #      OIL_BEFORE_FILTER_BOTTOM_Y,
            #      horizontal=True, start_joint='right', thin=True, contour=(2,)),
            # Pipe((2,), FUEL_BEFORE_FILTER_TOP_X, FUEL_BEFORE_FILTER_TOP_Y, FUEL_BEFORE_FILTER_BOTTOM_X,
            #      FUEL_BEFORE_FILTER_BOTTOM_Y,
            #      horizontal=False, start_joint='sharp', end_joint='right', thin=True, contour=(3,)),
            # Pipe((2,), FUEL_BEFORE_FILTER_TOP_X, FUEL_BEFORE_FILTER_BOTTOM_Y, CENTER_X + Settings.PUMP_THIN_LINE_WIDTH / 2,
            #      FUEL_BEFORE_FILTER_BOTTOM_Y,
            #      horizontal=True, start_joint='right', thin=True, contour=(2, 3)),
            # Pipe((2,), FUEL_AFTER_FILTER_TOP_X, FUEL_AFTER_FILTER_TOP_Y, FUEL_AFTER_FILTER_BOTTOM_X,
            #      OIL_AFTER_FILTER_BOTTOM_Y,
            #      horizontal=False, start_joint='sharp', end_joint='sharp', thin=True, contour=(2,)),
            #
            # # тонкие трубы бок
            # Pipe((2,), FUEL_TANK_1_START_X, FUEL_TANK_1_START_Y, FUEL_TANK_1_END_X,
            #      FUEL_TANK_1_END_Y,
            #      horizontal=True, start_joint='sharp', end_joint='right', thin=True, contour=(5,)),
            # Pipe((2,), FUEL_TANK_1_END_X, FUEL_TANK_1_END_Y, FUEL_TANK_3_END_X,
            #      FUEL_TANK_3_END_Y,
            #      horizontal=False, start_joint='right', thin=True, contour=(5,)),
            # Pipe((2,), FUEL_TANK_4_END_X, FUEL_TANK_4_END_Y, FUEL_TANK_5_END_X,
            #      FUEL_TANK_5_END_Y,
            #      horizontal=False, end_joint='sharp', thin=True, contour=(6,)),
            #
            # Pipe((2,), FUEL_TANK_3_END_X, FUEL_TANK_3_END_Y, FUEL_TANK_2_END_X,
            #      FUEL_TANK_2_END_Y,
            #      horizontal=False, start_joint='right', thin=True, contour=(4,)),
            # Pipe((2,), FUEL_TANK_2_END_X, FUEL_TANK_2_END_Y, FUEL_SMALL_PUMP_X,
            #      FUEL_TANK_2_END_Y,
            #      horizontal=True, start_joint='left', thin=True, contour=(4,)),
            # Pipe((2,), FUEL_SMALL_PUMP_X, FUEL_SMALL_PUMP_Y, FUEL_TANK_4_END_X,
            #      FUEL_TANK_4_END_Y,
            #      horizontal=True, end_joint='left', thin=True, contour=(4,)),
            # Pipe((2,), FUEL_TANK_4_END_X, FUEL_TANK_4_END_Y, FUEL_TANK_4_END_X,
            #      FUEL_TANK_3_END_Y,
            #      horizontal=False, start_joint='left', end_joint='left', thin=True, contour=(4,)),
            # Pipe((2,), FUEL_TANK_4_END_X, FUEL_TANK_3_END_Y, FUEL_TANK_1_END_X,
            #      FUEL_TANK_3_END_Y,
            #      horizontal=True, start_joint='left', end_joint='sharp', thin=True, contour=(4,)),
            #
            #
            ...
            #      horizontal=False, start_joint='sharp', thin=True, contour=(2,3)),
