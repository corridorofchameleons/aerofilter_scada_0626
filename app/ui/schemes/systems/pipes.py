...
from app.ui.layouts.scheme_layout import (
    ...
    FUEL_TANK_4_BOTTOM_Y, FUEL_SMALL_PUMP_X, COUNTER_START_X, COUNTER_START_Y, COUNTER_X, COUNTER_Y, CENTER_Y
)
    ...
    def __init__(
        ...
        self.pipes = [
            ...
            Pipe(x=OIL_AFTER_FILTER_X, y=OIL_FILTER_BOTTOM_Y, x2=OIL_BEFORE_FILTER_X,
                 ...
                 activate_flow=activate_flow),
            Pipe(x=OIL_BEFORE_FILTER_X, y=OIL_FILTER_BOTTOM_Y, x2=COUNTER_X - Settings.PIPE_THIN_WIDTH * 0.5,
                 thin=True, contour=(2, 3), arrows=(0.5,),
                 activate_flow=activate_flow),
            ...
            # внешний контур
            Pipe(x=FUEL_RIGHT_X, y=FUEL_TOP_Y, x2=FUEL_LEFT_X, y2=FUEL_TOP_Y,
            ...
            Pipe(x=FUEL_RIGHT_X, y=FUEL_RIGHT_BOTTOM_Y, x2=FUEL_RIGHT_X, y2=FUEL_TOP_Y,
            ...
            Pipe(x=FUEL_BEFORE_FILTER_X, y=FUEL_TOP_Y, y2=FUEL_FILTER_BOTTOM_Y,
                 start_joint='sharp', end_joint='right', thin=True, contour=(8,), arrows=(0.4, 0.8),
                 activate_flow=activate_flow),
            Pipe(x=FUEL_BEFORE_FILTER_X, y=FUEL_FILTER_BOTTOM_Y, x2=FUEL_AFTER_FILTER_X,
                 start_joint='right', thin=True, contour=(8,), arrows=(0.5,),
                 activate_flow=activate_flow),
            Pipe(x=FUEL_AFTER_FILTER_X, y=FUEL_FILTER_BOTTOM_Y, x2=COUNTER_X + Settings.PIPE_THIN_WIDTH * 0.5,
                 thin=True, contour=(8, 9), arrows=(0.5,),
                 activate_flow=activate_flow),
            Pipe(x=FUEL_AFTER_FILTER_X, y=FUEL_TOP_Y, y2=FUEL_FILTER_BOTTOM_Y,
                 start_joint='sharp', end_joint='sharp', thin=True, contour=(9,), arrows=(0.4, 0.8),
                 activate_flow=activate_flow),
            ...
            Pipe(x=COUNTER_X, y=OIL_FILTER_BOTTOM_Y, y2=COUNTER_Y,
