...
class ValveSystem(QObject):
    def __init__(
        ...
        self.valves = [
            ...
            (Valve(small=True, contour=(8,), tag=BinaryTags.units.get(FuelStand.counter_before_valve),
                   signal=handle_status_signal), (FUEL_VALVE_V3_X, FUEL_VALVE_V3_Y)),
            (Valve(small=True, contour=(9,), tag=BinaryTags.units.get(FuelStand.counter_after_valve),
