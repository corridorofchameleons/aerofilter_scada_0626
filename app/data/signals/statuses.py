...
class StatusSignals(QObject):
    oil_stand_active_signal = Signal(bool)
    ...
    fuel_counter_before_valve_disable_signal = Signal(bool)
    fuel_counter_after_valve_signal = Signal(bool)
    fuel_counter_after_valve_disable_signal = Signal(bool)
